...
public class AreasFacadeREST extends AbstractFacade<Areas> {
    ...
    public void create(Areas entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Long id, Areas entity) {
        super.edit(entity);
    }
    ...
    public Areas find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Areas> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
